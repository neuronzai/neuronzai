---
description: Re-scope THIS native agent session to a different Neuronz.ai profile (e.g. you launched in the wrong directory). Session-only — does NOT map the directory to the profile.
---
