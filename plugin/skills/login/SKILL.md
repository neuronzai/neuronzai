---
name: login
description: "Explicit-only Neuronz.ai workflow; use only when the user invokes the login workflow. Sign this machine in to Neuronz.ai in the browser and save a refreshable OAuth grant securely"
---

# Neuronz.ai login workflow
